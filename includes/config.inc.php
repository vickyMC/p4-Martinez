...
$url="https://p4-martinez.000webhostapp.com";
...
defined('DATABASE_NAME') ? NULL : define('DATABASE_NAME', 'id8007354_myinfo');
defined('DATABASE_USER') ? NULL : define('DATABASE_USER', 'id8007354_root');
defined('DATABASE_PASSWORD') ? NULL : define('DATABASE_PASSWORD', 'castro123');
